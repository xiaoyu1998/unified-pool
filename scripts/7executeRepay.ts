...
async function main() {
    ...
    eventEmitter.on("Repay", (pool, repayer, to, amount, collateral, debtScaled) =>{
        console.log("eventEmitter Repay" ,pool, repayer, to, amount, collateral, debtScaled);
    });
    ...
    const repayAmmount = expandDecimals(800000, usdtDecimals);
